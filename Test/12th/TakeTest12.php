<?php 
	...
	$query = "SELECT * FROM questions12 WHERE question_number = $number";
	...
	//Get Choices
	$query = "SELECT * FROM options12 WHERE question_number = $number";
...
<body>
    ...
    <main>
        <div class="container">
            ...
            <form method="POST" action="process12.php">
                <ul class="choicess">
